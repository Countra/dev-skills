...
CAPABILITIES: dict[str, Any] = {
    ...
    "not_supported": [
        {
            ...
            "likely_endpoint": "POST /projects/:id/issues",
            "required_scope": "api",
        },
        {"capability": "delete_project_or_repo_items", "reason": "destructive operation"},
        {"capability": "close_issue_or_mr", "reason": "state-changing operation outside current boundary"},
    ...
    "validation_boundary": {
        ...
        "live_read": ["/user", "project search/get", "issue list/get", "notes list", "project search"],
        "live_write": ["single marked issue/MR note in codex_test only"],
    },
}
