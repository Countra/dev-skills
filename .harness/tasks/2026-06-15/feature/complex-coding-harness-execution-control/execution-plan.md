...
| Stage 2 Commit Log 更新 | pending | 提交后回填 hash |
...
| Stage 2 当前阶段提交或未提交原因已记录 | pending | 提交后回填 |
...
- Stage 1 和 Stage 2 完成后均不停止，按 `continue Stage 3` 继续。
...
- `minor`: Stage 1 已覆盖入口和 workflow，Stage 2 已覆盖模板，eval 仍需 Stage 3 落地。
